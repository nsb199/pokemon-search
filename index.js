...
pokemonSearchForm.addEventListener('submit', (event) => {
    ...
    const searchValue = document.querySelector('#pokemon-search-input').value.toLowerCase();
    const filterPokemon = pokemonArray.filter(pokemon => pokemon.name.includes(searchValue));
    clearPokedex();
